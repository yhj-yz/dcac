...
public class Rc4Utils {
	...
	public static final String KEY1 = "DocGuarder_Encrypt_System_Made_in_HangZhou_2011_10_26";
	public static final String KEY2 = "DGWorkFlowDomainLogNameDGWorkFlowDomainPass";
	private Rc4Utils() {
	}
	...
	public static String encode(String input){
		String encodeStr = encode(input, KEY2);
		return encodeStr;
	}
	public static String encode(String input, String key){
		String encodeStr = Base64.encodeBase64String(RC4Base(input.getBytes(), key));
		return encodeStr;
	}
	public static String decode(String input){
		String decodeStr = decode(input,KEY2);
		return decodeStr;
	}
	public static String decode(String input, String key){
		String decodeStr = new String(RC4Base(Base64.decodeBase64(input), key));
		return decodeStr;
	}
	...
	public static void main(String[] args) {
        ...
        String key = "DGWorkFlowDomainLogNameDGWorkFlowDomainPass";
        String str = encry_RC4_string(inputStr, key);
        System.out.println(encode("qwer1234"));
