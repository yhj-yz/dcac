						...
						<div class="dsm-inline">
							...
							<div class="dsm-input-block">
								<input type="text" autocomplete="off" placeholder="用户组名称"
									class="dsm-input required specialChar" name="groupName" value="${group.groupName}">
						...
						<div class="dsm-inline">
							...
							<div class="dsm-input-block">
								<input type="text" autocomplete="off" placeholder="用户组描述"
									class="dsm-input" name="groupDesc" value="${group.groupDesc}">
							</div>
						</div>
						<div class="dsm-inline">
								...
								<div class="dsm-box clearfix">
									...
									<div id="openUserGroup" class="datachosebox clearfix"
										...
										<div class="cright">
											...
											<div class="itembox">
												<div class="items">
													[#list group.users as u]
													<div class="itemcheckone">
													<div class="dsmcheckbox">
								                		<input type="hidden" value="${u.id}"  name="userIds">
								                		<input type="checkbox" value="${u.id}" class="checkeduser" id="u_${u.id}">
														<label for="u_${u.id}"></label>
													</div>
													<label for="u_${u.id}">${u.name}[${u.account}]</label>
													</div>
													[/#list]
												</div>
											</div>
