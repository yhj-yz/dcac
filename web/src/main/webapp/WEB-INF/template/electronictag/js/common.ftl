...
var messages = {
	...
	"admin.validate.required": "<span style='color: red;'>*</span>${message("admin.validate.required")}",
	"admin.validate.email": "<span style='color: red;'>*</span>${message("admin.validate.email")}",
	"admin.validate.url": "<span style='color: red;'>*</span>${message("admin.validate.url")}",
	"admin.validate.date": "<span style='color: red;'>*</span>${message("admin.validate.date")}",
	"admin.validate.dateISO": "<span style='color: red;'>*</span>${message("admin.validate.dateISO")}",
	"admin.validate.pointcard": "<span style='color: red;'>*</span>${message("admin.validate.pointcard")}",
	"admin.validate.number": "<span style='color: red;'>*</span>${message("admin.validate.number")}",
	"admin.validate.digits": "<span style='color: red;'>*</span>${message("admin.validate.digits")}",
	"admin.validate.minlength": "<span style='color: red;'>*</span>${message("admin.validate.minlength")}",
	"admin.validate.maxlength": "<span style='color: red;'>*</span>${message("admin.validate.maxlength")}",
	"admin.validate.rangelength": "<span style='color: red;'>*</span>${message("admin.validate.rangelength")}",
	"admin.validate.min": "<span style='color: red;'>*</span>${message("admin.validate.min")}",
	"admin.validate.max": "<span style='color: red;'>*</span>${message("admin.validate.max")}",
	"admin.validate.range": "<span style='color: red;'>*</span>${message("admin.validate.range")}",
	"admin.validate.accept": "<span style='color: red;'>*</span>${message("admin.validate.accept")}",
	"admin.validate.equalTo": "<span style='color: red;'>*</span>${message("admin.validate.equalTo")}",
	"admin.validate.remote": "<span style='color: red;'>*</span>${message("admin.validate.exist")}",
	"admin.validate.integer": "<span style='color: red;'>*</span>${message("admin.validate.integer")}",
	"admin.validate.positive": "<span style='color: red;'>*</span>${message("admin.validate.positive")}",
	"admin.validate.negative": "<span style='color: red;'>*</span>${message("admin.validate.negative")}",
	"admin.validate.decimal": "<span style='color: red;'>*</span>${message("admin.validate.decimal")}",
	"admin.validate.pattern": "<span style='color: red;'>*</span>${message("admin.validate.illegal")}",
	"admin.validate.extension": "<span style='color: red;'>*</span>${message("admin.validate.extension")}",
	"dsm.page.total": "${message("dsm.page.total")}",
	"dsm.page.pageSize": "${message("dsm.page.pageSize")}",
	"dsm.page.totalPages": "${message("dsm.page.totalPages")}",
	"dsm.page.pageTo": "${message("dsm.page.pageTo")}",
	"dsm.page.number": "${message("dsm.page.number")}",
};
