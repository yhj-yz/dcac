...
<div class="dsm-rightside">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.js-advice', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var fragment1;
                    var fragment2;
                    var srcFileUrls = data.srcFileUrls.replace(";","");
                    var destFileUrls = data.destFileUrls.replace(";","");
                    fragment1 += "<tr><td class='dsm-td'>" + srcFileUrls + "</td><td><span class=\"fbtname\" onclick=\'download($(this))\'>下载</span></td>" + "</tr>";
                    $("#tableList").append(fragment1);
                    fragment2 += "<tr><td class='dsm-td'>" + destFileUrls + "</td><td><span class=\"fbtname\" onclick=\'download($(this))\'>下载</span></td>" + "</tr>";
        ...
        function showCircultionAddress() {
            $("#search_form").attr("action", "${base}/admin/task/search.jhtml?state=5");
            refreshUserPageList();
        }
            ...
            refreshPageList({
                ...
                dataFormat: function (_data) {
                    ...
                    var _text = "<tr>" +
                            ...
                            "<td class='hiddentd'><div class='hiddendiv' title='" + _data.applyUser + "'>" + _data.applyUser + "</div></td>" +
                            "<td class='hiddentd'><div class='hiddendiv' title='" + _data.applyTime + "'>" + _data.applyTime + "</div></td>" +
                            "<td class='hiddentd'><div class='hiddendiv' title='" + _data.taskState + "'>" + _data.taskState + "</div></td>" +
                            "<td class='hiddentd'><div class='hiddendiv' title='" + valueIsNull(_data.advice) + "'>" + valueIsNull(_data.advice) + "</div></td>" +
                            "<td class='hiddentd'><div class='hiddendiv' title='" + _data.approveTime + "'>" + _data.approveTime + "</div></td>" +
                            "</tr>";
                    index++;
                    return _text;
                }
