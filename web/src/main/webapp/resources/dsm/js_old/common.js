...
var messages = {
	...
	"admin.validate.required": "<span style='color: red;'>*</span>必填",
	"admin.validate.email": "<span style='color: red;'>*</span>E-mail格式错误",
	"admin.validate.url": "<span style='color: red;'>*</span>网址格式错误",
	"admin.validate.date": "<span style='color: red;'>*</span>日期格式错误",
	"admin.validate.dateISO": "<span style='color: red;'>*</span>日期格式错误",
	"admin.validate.pointcard": "<span style='color: red;'>*</span>信用卡格式错误",
	"admin.validate.number": "<span style='color: red;'>*</span>只允许输入数字",
	"admin.validate.digits": "<span style='color: red;'>*</span>只允许输入零或正整数",
	"admin.validate.minlength": "<span style='color: red;'>*</span>长度不允许小于{0}",
	"admin.validate.maxlength": "<span style='color: red;'>*</span>长度不允许大于{0}",
	"admin.validate.rangelength": "<span style='color: red;'>*</span>长度必须在{0}-{1}之间",
	"admin.validate.min": "<span style='color: red;'>*</span>不允许小于{0}",
	"admin.validate.max": "<span style='color: red;'>*</span>不允许大于{0}",
	"admin.validate.range": "<span style='color: red;'>*</span>必须在{0}-{1}之间",
	"admin.validate.accept": "<span style='color: red;'>*</span>输入后缀错误",
	"admin.validate.equalTo": "<span style='color: red;'>*</span>两次输入不一致",
	"admin.validate.remote": "<span style='color: red;'>*</span>已存在",
	"admin.validate.integer": "<span style='color: red;'>*</span>只允许输入整数",
	"admin.validate.positive": "<span style='color: red;'>*</span>只允许输入正数",
	"admin.validate.negative": "<span style='color: red;'>*</span>只允许输入负数",
	"admin.validate.decimal": "<span style='color: red;'>*</span>数值超出了允许范围",
	"admin.validate.pattern": "<span style='color: red;'>*</span>非法字符",
	"admin.validate.extension": "<span style='color: red;'>*</span>文件格式错误",
	"dsm.page.total": "共{0}页/{1}条数据",
	"dsm.page.pageSize": "每页显示",
	"dsm.page.totalPages": "共{0}页",
	"dsm.page.pageTo": "跳转到第",
	"dsm.page.number": "页",
};
...
(function($) {
	...
	$(".aside [data-ride='collapseson']").each(function (index) {
        if ($("#mainIframe").attr("src")== $(this).attr("data-link")) {
	...
	$(document).on('click', '[data-ride="collapse"] a', function (e) {
        ...
        $active && $active.toggleClass('active').find('> ul:visible').hide();

        ($this.parent().hasClass('active') && $this.next().hide()) || $this.next().show();
